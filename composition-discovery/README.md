...
1. Inject 1 → N middleware(s) _between_ two matched services (they must directly chain together)
2. Inject 1 → N middleware(s) _before_ any service (will place middleware before that service wherever it shows up in the composition)
